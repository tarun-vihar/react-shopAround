...
class Product(models.Model):
    ...
    numReviews = models.CharField(max_length=20, null=True, blank=True, default='0')
    price =  models.CharField(max_length=20, null=True, blank=True)
    countInStock =  models.CharField(max_length=20, null=True, blank=True, default='0')
...
class ShoppingListDetails(models.Model):
    product = models.ForeignKey(Product, on_delete=models.SET_NULL, null=True)
    order = models.ForeignKey(ShoppingList, on_delete=models.CASCADE, null=True)
    name = models.CharField(max_length=200, null=True, blank=True)
    qty = models.IntegerField(null=True, blank=True, default=0)
    price = models.DecimalField(
        max_digits=7, decimal_places=2, null=True, blank=True)
